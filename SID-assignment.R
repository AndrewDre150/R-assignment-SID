...
# Check unique customer IDs in online sales data
unique_customer_ids_online <- unique(online_sales$customer_ID)

# Check unique customer IDs in in-store sales data
unique_customer_ids_in_store <- unique(in_store_sales$customer_ID)

# Check unique customer IDs in customer demographics data
unique_customer_ids_demographics <- unique(customer_demographics$customer_ID)

# Compare unique customer IDs between datasets
consistent_ids <- intersect(intersect(unique_customer_ids_online, unique_customer_ids_in_store), unique_customer_ids_demographics)

# Show inconsistent IDs
inconsistent_ids_online <- setdiff(unique_customer_ids_online, consistent_ids)
inconsistent_ids_in_store <- setdiff(unique_customer_ids_in_store, consistent_ids)
inconsistent_ids_demographics <- setdiff(unique_customer_ids_demographics, consistent_ids)

# Print inconsistent IDs
print("Inconsistent IDs in online sales data:")
print(inconsistent_ids_online)

print("Inconsistent IDs in in-store sales data:")
print(inconsistent_ids_in_store)

print("Inconsistent IDs in customer demographics data:")
print(inconsistent_ids_demographics)
